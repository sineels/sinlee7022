...
우리는 우리의 유일한 재량에 따라 언제든 이러한 서비스 조건을 개정할 권리를 유보하고 그러한 개정이 있을 경우 이러한 서비스 조건을 업데이트할 것입니다. 우리는 사용자에게 가격 인상과 같은 본 계약의 물질적 변경 사항을 통보할 것입니다. 변경이 시행되기 최소 30일 전에는 귀하의 GitHub 계정에 명시된 주요 이메일 주소로 이메일을 보내십시오. 고객이 그 30일 후에 서비스를 계속 사용하는 것은 그 서비스에 대한 합의에 해당합니다. 본 계약의 개정. 다른 수정 사항에 대해, 웹 사이트를 계속 사용하는 것은 이러한 서비스 조건의 개정에 대한 합의를 구성합니다. 우리는 이 용어의 모든 변화를 볼 수 있습니다. [사이트 정책](https://github.com/github/site-policy) 저장소

우리는 통지가 있든 없든 간에 웹사이트(또는 그 일부)를 수정하거나 영구적으로 중단할 수 있는 권리를 언제, 수시로 예약합니다.

## R. 잡다

### 1. 통치법

적용 가능한 법률이 달리 규정하는 한도에서를 제외하고, 당신과 GitHub 사이의 이 협정과 웹사이트 또는 서비스의 접근 또는 사용은 법률 규정의 충돌과 관련하여 미국 연방법과 캘리포니아 주의 법률에 의해 규율된다. 당신과 GitHub은 캘리포니아 주 샌프란시스코 시 및 카운티에 위치한 법원의 독점 관할권과 장소에 제출하기로 동의합니다.

### 2. 비할당성

    GitHub은 이러한 서비스 조건 및/또는 위임할 수 있습니다.      [깃허브 프라이버시 성명](https://github.com/site/privacy)제 D.4절의 라이센스 부여를 포함하여 동의가 있거나 없는 모든 사람 또는 개체에게 전부 또는 일부. 선서적 동의 없이는 복무조건 또는 개인보호증서에 따른 권리 또는 의무를 부여하거나 위임할 수 없으며, 본인에 의한 무단적 위임은 무효이다.

###         3. 섹션 제목 및 요약       

본 계약 전반에 걸쳐 각 섹션에는 다음 약관의 제목 및 간략한 요약이 포함됩니다. 이 섹션 제목과 간략한 요약은 법적 구속력이 없습니다.

###         4. 심각성, 포기 없음 및 생존       

본 계약의 일부분이 무효 또는 집행이 불가능하게 유지된다면, 그 부분은 당사자의 원래 의도를 반영하도록 해석될 것입니다. 나머지 부분은 완전한 힘과 효과를 유지할 것이다. GitHub이 본 계약의 어떠한 규정도 시행하지 못한 것은 그러한 규정의 집행권의 포기로 간주되지 않을 것이다. 본 계약에 따른 우리의 권리는 본 계약의 해지에서 살아남을 것입니다.

###        5. 수정 사항; 완전한 협정      

    은근한 깃허브의 은근한 기트허브의 은근한 기트허브의 은근한 기트허브는 기트허브의 은근한 기트허브는 기트허브의 일손을 만드시며 일손을 만드시킵니다. [Q. 용어의 개구부](#q-changes-to-the-terms). 이러한 서비스 조건은 GitHub Privacy 성명과 함께 당신과 우리 사이의 합의의 완전하고 독점적인 진술을 나타낸다. 본 계약은 기밀 또는 비공개 협정을 포함한 이러한 조건의 주제와 관련된 제안 또는 사전 합의 또는 서면 및 기타 기타 깃허브 사이의 통신을 대체합니다..

###       6. 질문     

서비스 약관 에프티 엠 엠 에프 에프티 에프 에프 에프티 에프 에프 에프티 에프 디 에프 에프 에프티 에프티에프 에스트 에프티시 에프티에프티 에프 엔드 에프 엔 에프 엔에프 에프 엔에프 엔에프 엔에프  
제목: GitHub 서비스 조건
redirect_from:
  - /tos
  - /terms
...
GitHub을 사용해 주셔서 감사합니다! 당신이 여기 있어 행복해요. GitHub에 접속하거나 사용하기 전에 이 서비스 약관 동의서를 주의 깊게 읽어주세요. 우리와 우리 사용자 사이에 이렇게 중요한 계약이기에 최대한 명확히 하려고 노력해 왔다. 귀하의 편의를 위하여, 우리는 이러한 용어를 구속력이 없는 짧은 요약으로 제시하였고, 그 다음에는 완전한 법률 용어로 제시하였다.

##         요약       

|        섹션        |         거기서 무엇을 찾을 수 있습니까?         |
| --- | --- |
| [A. 정의](#a-정의) |  이 합의를 이해하는 데 도움이 될 수 있는 방법으로 정의된 몇 가지 기본 용어. 이 절을 참조하여 설명하십시오.  |
| [B. 계정항](#b-계좌) |     이것은 GitHub에 대한 계정을 갖는 기본 요건입니다.     |
| [C. 허용가능한 사용](#c-수용가능-사용)|     이것은 GitHub 계정을 사용할 때 반드시 따라야 하는 기본 규칙입니다.     |
| [D. 사용자 생성 콘텐츠]   (#d-user 생성 콘텐츠)     |     깃허브에 올리는 내용을 소유하고 있습니다. 그러나 이에 대한 책임은 어느 정도 있으며, 우리에게 서비스를 제공할 수 있도록 권리를 부여해 달라고 요청합니다.     |
| [E. 개인 저장소]   (#e-개인 저장소)     |     이 절에서는 GitHub이 개인 저장소에 게시하는 내용을 어떻게 취급할 것인지에 대해 이야기한다.     |
| [F.저작권및DMCA정책]   (#f-저작권 침해와 dmca-정책)     |     이 절에서는 누군가가 GitHub에 대한 저작권을 침해하고 있다고 믿는다면 GitHub이 어떻게 대응할 것인가에 대해 이야기한다.     |
| [G. 지적 재산권 통지](#g-지적-재산-고지) |     이것은 웹사이트와 서비스에서 GitHub의 권리를 설명합니다.     |
| [H. API 조건](#h-아피-텀스) |     개발이나 데이터 수집을 위해 API를 사용하고 있든 간에 GitHub의 API를 사용하는 규칙입니다.     |
| [I. 추가 제품 용어](#i-github-추가-제품-항) |     우리는 GitHub의 특징과 제품에 대한 몇 가지 구체적인 규칙을 가지고 있습니다.     |
| [J. 베타 프리뷰](#j-베타-프리뷰) |     이들은 아직 개발 중인 GitHub의 기능에 적용되는 추가 용어 중 일부이다.     |
| [K. 결제](#k-payment) | 당신은 지불 책임이 있습니다. 우리는 당신에게 정확하게 청구할 책임이 있습니다. |
| [L. Cancellation and Termination](#l-cancellation-and-termination) | You may cancel this agreement and close your Account at any time. |
| [M. Communications with GitHub](#m-communications-with-github) | We only use email and other electronic means to stay in touch with our users. We do not provide phone support. |
| [N. Disclaimer of Warranties](#n-disclaimer-of-warranties) | We provide our service as is, and we make no promises or guarantees about this service. **Please read this section carefully; you should understand what to expect.** |
| [O. Limitation of Liability](#o-limitation-of-liability) | We will not be liable for damages or losses arising from your use or inability to use the service or otherwise arising under this agreement. **Please read this section carefully; it limits our obligations to you.** |
